...
| 模組名稱 | 資源連結 (URL) | 備註說明 (Memo) |
| :--- | :--- | :--- |
| **稅籍模組** | [點擊跳轉](#) | 包含每日稅籍資料爬取與 ETL 邏輯 |
| **國貿局模組** | [點擊跳轉](#) | 對接貿易局 API，目前處於模組化測試階段 |
| **工廠模組** | [點擊跳轉](#) | 負責工廠登記資料之流向控制 |
| **商工公司模組** | [點擊跳轉](#) | GCIS 批次處理單元測試版本 (251007) |
| **商工商業模組** | [點擊跳轉](#) | 商業登記資料同步，需注意欄位對齊 |
...
## GCIS 商工
- **主要程式**: [tax_daily_v3_純GCIS.py](hncb_crawler/自動化網爬架構/lab_crawler/舊版code/tax/tax_daily_v2/手術區/tax_daily_v3_純GCIS.py)
### 這份程式在幹嘛（重點版）
